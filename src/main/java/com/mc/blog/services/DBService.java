...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Artigos artigos = new Artigos(null,"artigo 1","descricao do artigo 1",null,"Conteudo",cli1,null,new Date());
		artigos.setCategoria(c1);

        Artigos artigos2 = new Artigos(null,"artigo 2","descricao do artigo 1",null,"Conteudo",cli1,null,new Date());
        artigos2.setCategoria(c5);

        Artigos artigos3 = new Artigos(null,"artigo 3","descricao do artigo 3","url","Conteudo",cli1,null,new Date());
        artigos3.setCategoria(c3);

        Artigos artigos4 = new Artigos(null,"artigo 4","descricao do artigo 4","url","Conteudo",cli1,null,new Date());
        artigos4.setCategoria(c4);

		Artigos artigos5 = new Artigos(null,"artigo 5","descricao do artigo 5","url","Conteudo",cli1,null,new Date());
